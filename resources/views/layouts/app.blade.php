...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="z-index:100">
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('home') }}">Active</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('buyhouses.index') }}">買屋</a>
                </li>
                <li class="nav-item">
